jQuery(function(jQuery) {
    ...
    var file_frame,
        ...
        admin_thumb_ul: '',
        init: function() {
            this.admin_thumb_ul = jQuery('#risp_gallery_thumbs');
            ...
            jQuery('#risp_gallery_upload_button').on('click', function(event) {
                ...
                file_frame.on('select', function() {
                    ...
                    for (var i = 0; i < length; i++) {
                        rpggallery.risp_get_thumbnail(images[i]['id']);
                    }
                });
                file_frame.open();
            });

			jQuery('#risp_delete_all_button').on('click', function() {
        ...
        risp_get_thumbnail: function(id, cb) {
            cb = cb || function() {
            };
            var data = {
                action: 'ris_get_thumbnail',
                imageid: id
            };
