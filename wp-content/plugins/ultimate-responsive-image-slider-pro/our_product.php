...
<div class="block ui-tabs-panel deactive" id="option-ourproduct">
	<div class="row-fluid pricing-table pricing-three-column">
		...
		<div class="plan-name">
			<h2>Weblizar Premium WordPress Products</h2>
			<h6>Get The WordPress Premium Themes & Plugins to Design Your Website Beautiful</h6>
		</div>
		<div class="section container">
			...
			<div class="col-lg-6">
				...
				<ol id="weblizar_product">
					<li><a href="http://weblizar.com/plugins/responsive-photo-gallery-pro//">Responsive Photo Gallery Pro</a></li>
					<li><a href="https://weblizar.com/plugins/photo-video-link-gallery-pro/">Photo Video Link Gallery Pro</a></li>
					<li><a href="http://weblizar.com/plugins/responsive-portfolio-pro/">Responsive Portfolio Pro</a></li>
					<li><a href="http://weblizar.com/lightbox-slider-pro/">Lightbox Slider Pro</a></li>
					<li><a href="http://weblizar.com/plugins/flickr-album-gallery-pro/">Flickr Album Gallery Pro</a></li>
					<li><a href="https://weblizar.com/plugins/instagram-shortcode-and-widget-pro/">Instagram Shortcode & Widget Pro</a></li>
					<li><a href="https://weblizar.com/plugins/instagram-gallery-pro/">Instagram Gallery Pro</a></li>
					<li><a href="https://weblizar.com/plugins/gallery-pro/">Gallery Pro</a></li>
				</ol>
			</div>
		</div>	
		<div class="section container" id="product_decs" style="text-align:center">
			<p>To find out more products details please visit our site.</p>	
			<div class="purchase_btn_div">
		  <a href="https://www.weblizar.com" target="_new" class="btn btn-primary btn-lg dmobtn">View Site</a>		
		</div>
		</div>
	</div>											
</div>