...
if ( 'posts' == get_option( 'show_on_front' ) ) {
	...
	<?php
		...
		$sections_array = apply_filters( 'parallax_one_plus_sections_filter',array('sections/parallax_one_latest_news_section', 'sections/parallax_one_our_story_section', 'sections/parallax_one_our_team_section', 'sections/parallax_one_ribbon_section', 'sections/parallax_one_contact_info_section', 'sections/parallax_one_map_section' ) );
